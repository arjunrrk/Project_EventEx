...
public class StarredEventDetails extends AppCompatActivity {
...
//                    google_calendar_client.setClassName("com.google.android.calendar", "com.android.calendar.LaunchActivity");
    ...
    private class BackgroundTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            GoogleSignInAccount account = GoogleSignIn.getLastSignedInAccount(StarredEventDetails.this);
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            overridePendingTransition(0, 0);
            Toast.makeText(StarredEventDetails.this, "Event added to Google Calendar", Toast.LENGTH_LONG).show();
        }
    }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == R.id.delete_icon) {
            AlertDialog.Builder builder = new AlertDialog.Builder(StarredEventDetails.this);
            ...
            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int id) {
                    ...
                    assert account != null;
                    String table_name = Objects.requireNonNull(account.getDisplayName()).replaceAll("\\s", "");
                    databaseHelper = new DatabaseHelper(StarredEventDetails.this);
                    SQLiteDatabase db = databaseHelper.getWritableDatabase();
                    int position = getIntent().getIntExtra("selected_event", 0);
